...
import "./Movie.css"
import { useParams } from "react-router-dom" //prendiamo come parametro id che sta su App.jsx per prendere l'id del film cliccato
            ...
            <div className="movie-detail">
                <div className="movie-detailLeft">
                    <div className="movie-posterBox">
                        <img className="movie-poster" src={`https://image.tmdb.org/t/p/original${currentMovieDetail ? currentMovieDetail.backdrop_path : ""}`} />
                    </div>
                </div>
